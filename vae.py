...
brief:  the script to train and evaluate the deep network for audio source separt=ation based on Variational Autoencoders
...
'''
	...
	brief: function to plot the improvements after denoising the samples to monitor the progress over ecpochs
	
	return:
		fig-> plot of the denoised samples to be saved
'''
...
'''
	params:
		size-> size of the vector to be intialized
		
	brief: function to randomly initialize the weights following the xavier initialization
...
'''
	param:
		X-> input_data
	brief: function to project the input to the latent space
	
	return:
		z_mu-> the mean of the projected data in latent space
		z_logvar-> the log variance of the projected data in the latent space
'''
...
'''
	param:
		mu-> the mean of the projected data in latent space
		logvar-> the log variance of the projected data in the latent space
		
	brief: function to draw one sample described by the input parameters 
	
	return: the drawn sample from input gaussian distribution
...
'''
	parmas:
		z-> the drawn sample from the distribution in latent space
		
	brief: the function to forward pass the generated sample through the decoder
